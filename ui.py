...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(681, 389)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Dialog.setWindowIcon(icon)
        self.communicationGroupBox = QtWidgets.QGroupBox(Dialog)
        self.communicationGroupBox.setGeometry(QtCore.QRect(10, 260, 211, 121))
        ...
        self.portRefreshButton = QtWidgets.QPushButton(self.communicationGroupBox)
        ...
        self.communicationApplyButton = QtWidgets.QPushButton(self.communicationGroupBox)
        self.communicationApplyButton.setGeometry(QtCore.QRect(10, 90, 191, 28))
        ...
        self.samplingGroupBox.setGeometry(QtCore.QRect(230, 261, 231, 121))
        ...
        self.samplingApplyButton.setGeometry(QtCore.QRect(10, 90, 211, 28))
        ...
        self.dataCollectionGroupBox.setGeometry(QtCore.QRect(470, 261, 201, 121))
        self.dataCollectionGroupBox.setObjectName("dataCollectionGroupBox")
        self.durationLineEdit = QtWidgets.QLineEdit(self.dataCollectionGroupBox)
        ...
        self.dataCollectionStartButton = QtWidgets.QPushButton(self.dataCollectionGroupBox)
        self.dataCollectionStartButton.setGeometry(QtCore.QRect(10, 90, 181, 28))
        self.dataCollectionStartButton.setObjectName("dataCollectionStartButton")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.communicationGroupBox.setTitle(_translate("Dialog", "Communication"))
        ...
        self.dataCollectionGroupBox.setTitle(_translate("Dialog", "Data Collection"))
